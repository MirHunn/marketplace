...
import 'a3_buyer_registration_model.dart';
export 'a3_buyer_registration_model.dart';

class A3BuyerRegistrationWidget extends StatefulWidget {
  const A3BuyerRegistrationWidget({super.key});

  @override
  State<A3BuyerRegistrationWidget> createState() =>
      _A3BuyerRegistrationWidgetState();
}

class _A3BuyerRegistrationWidgetState extends State<A3BuyerRegistrationWidget> {
  late A3BuyerRegistrationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A3BuyerRegistrationModel());
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  16.0, 12.0, 16.0, 0.0),
                              child: TextFormField(
                                controller: _model.passwordTextController4,
                                focusNode: _model.passwordFocusNode4,
                                onChanged: (_) => EasyDebounce.debounce(
                                  '_model.passwordTextController4',
                                  const Duration(milliseconds: 100),
                                  () => safeSetState(() {}),
                                ),
                                autofocus: false,
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(16.0, 12.0, 16.0, 33.0),
                    child: FFButtonWidget(
                      onPressed: ((_model.displayNameTextController.text ==
                              ...
                              (_model.passwordTextController4.text == ''))
                          ? null
                          : () async {
                              ...
                              await UsersRecord.collection
                                  ...
                                  .update(createUsersRecordData(
                                    ...
                                    city: _model.passwordTextController1.text,
                                    streetaddress:
                                        _model.passwordTextController2.text,
                                    postalcode:
                                        _model.passwordTextController3.text,
