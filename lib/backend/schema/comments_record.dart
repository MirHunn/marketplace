...
class CommentsRecord extends FirestoreRecord {
  ...
  // "Whichservice" field.
  DocumentReference? _whichservice;
  DocumentReference? get whichservice => _whichservice;
  bool hasWhichservice() => _whichservice != null;
  ...
  void _initializeFields() {
    ...
    _whichservice = snapshotData['Whichservice'] as DocumentReference?;
...
Map<String, dynamic> createCommentsRecordData({
  ...
  String? commentText,
  DocumentReference? whichservice,
  int? commentnumber,
}) {
...
class CommentsRecordDocumentEquality implements Equality<CommentsRecord> {
  ...
  bool equals(CommentsRecord? e1, CommentsRecord? e2) {
    return e1?.commentUser == e2?.commentUser &&
        ...
        e1?.whichservice == e2?.whichservice &&
