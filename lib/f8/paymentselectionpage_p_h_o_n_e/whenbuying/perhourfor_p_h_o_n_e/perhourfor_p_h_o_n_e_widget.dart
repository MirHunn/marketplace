...
import 'perhourfor_p_h_o_n_e_model.dart';
export 'perhourfor_p_h_o_n_e_model.dart';

class PerhourforPHONEWidget extends StatefulWidget {
  const PerhourforPHONEWidget({
    super.key,
    required this.clickedpricingtemplate1,
  });

  final PricingtemplateRecord? clickedpricingtemplate1;

  @override
  State<PerhourforPHONEWidget> createState() => _PerhourforPHONEWidgetState();
}

class _PerhourforPHONEWidgetState extends State<PerhourforPHONEWidget> {
  late PerhourforPHONEModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PerhourforPHONEModel());
  }
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          valueOrDefault<String>(
                                            widget.clickedpricingtemplate1
                                                ?.descriptionPERHOUR,
                                            '/',
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                        ...
                                        queryParameters: {
                                          'checkoutperhourPH': serializeParam(
                                            containerPricingtemplateRecord,
                                            ParamType.Document,
                                          ),
                                        }.withoutNulls,
                                    ...
                                    child: Container(
                                      ...
                                      child: Align(
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'aflumje9' /* Check for availability and mor... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
