...
class ReviewsWidget extends StatefulWidget {
  ...
  final DocumentReference? servicereviews;
    ...
    return Container(
      ...
      child: StreamBuilder<List<ReviewRecord>>(
        stream: queryReviewRecord(
          parent: widget.servicereviews,
          queryBuilder: (reviewRecord) =>
              reviewRecord.orderBy('date', descending: true),
        ),
                  ...
                  children: [
                    Padding(
                      ...
                      child: StreamBuilder<UsersRecord>(
                        stream:
                            UsersRecord.getDocument(columnReviewRecord.userID!),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
